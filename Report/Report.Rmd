...
```{r figure1, message=FALSE, echo=FALSE, warning=FALSE, out.width="90%"}
...
```{r figure2, message=FALSE, echo=FALSE, warning=FALSE, out.width="90%"}
...
```{r, message=FALSE, echo=FALSE, warning=FALSE, height="70%"}
