...
Summarizes of statistics are shown in tables. Table 1 illustrates the variables that this analysis concerns about in each state in the US, which are COVID-19 Deaths, COVID-19 Deaths proportion, COVID-19 Fully Vaccinated number and COVID-19 Fully Vaccinated proportion. Here only shows the numbers of first ten states. The whole table is in the Appendix (Table 1). From this table, we can get that the three states that have the highest deaths are California, Texas and Florida, which have 221,775, 218,261 and 169,626, respectively. Also, the three states that have the highest proportion of deaths in total deaths are New Jersey, Mississippi and Connecticut, which are 16.4%, 14.7% and 14%, respectively. As for the condition of fully vaccinated, the three states that have the highest number are California, Texas and New York, which are 23,996,305, 15,347,006 and 12,850,740, respectively. Additionally, the three states that have the highest proportion of fully vaccinated in the population are Vermont, Maine and Connecticut, which are 35.4%, 35.2% and 35.1%, respectively.
...
Bar charts and maps are shown to have a better view of the condition of COVID-19 Deaths and status of fully vaccinated in different states among age groups.
...
\begin{center}
Plot 1 COVID-19 Deaths by States and Age Group
\end{center}
...
\begin{center}
Plot 2 COVID-19 Deaths Proportions by States and Age Group
\end{center}

From the bar chart of deaths due to Covid-19 (Plot 1), we can straightly get that the largest numbers of deaths due to Covid-19 were in Texas and California. It is also obvious that the numbers of deaths in people older than 65 were much larger than those in other age groups. When looking at the bar chart of death proportions due to Covid-19 among all deaths (Plot 2), we get that the largest proportion was in Texas, while that of other states were quite even.
...
\begin{center}
Plot 3 Maps of COVID-19 Deaths and Proportions in the US
\end{center}

Maps of deaths due to Covid-19 (Plot 3A) and death proportions due to Covid-19 (Plot 3B) show a more straight forward view of the condition of deaths in the US. Darker states had more deaths or larger death proportions.
...
\begin{center}
Plot 4 Fully Vaccinated by States and Age Group
\end{center}
...
\begin{center}
Plot 5 Fully Vaccinated Proportions by States and Age Group
\end{center}

From the bar chart of numbers of people who were fully vaccinated (Plot 4) we can straightly get that the largest number of people who have got fully vaccinated was in California. It is also obvious that the numbers in people who were between 18 to 65 years old were much larger than those in other age groups. When looking at the bar chart of fully vaccinated proportions among the population (Plot 5), we get that the largest proportions were in Vermont, Rhode Island and Connecticut. The reason that California had the most deaths but didn't have the highest proportion of deaths was probably because California had larger population compared to most of other states. Also, the proportions of fully vaccinated in people who were older than 65 years old were larger than those in other age groups.
...
\begin{center}
Plot 6 Maps of Fully Vaccinated and Proportions in the US
\end{center}

In the maps of deaths (Plot 6A), states that are darker in the maps have more deaths or larger proportion of deaths. In the maps of status of fully vaccinated (Plot 6B), states that are darker in the maps have larger number or proportion of people who were fully vaccinated.
...
\begin{center}
Plot 7 Fully Vaccinated Proportion vs. Deaths Proportion
\end{center}
